...
using namespace std; //For debug prints

template<int N>
void stream(lbgrid &node, lbgrid &cell) {
	//SCP SHIFT
	//Positive (1,0,0)...
	for (int i3 = node.SCP.iE3; i3 >= node.SCP.iB1; i3--) {
			...
			for (int i1 = node.SCM.iB1; i1 <= node.SCM.iE1; i1++) {
				 node.SCM(i1,i2,i3,DV_M1_ZERO_ZERO) = node.SCM(i1+node.SCM.nB1,i2,i3,DV_M1_ZERO_ZERO);
	      			 node.SCM(i1,i2,i3,DV_ZERO_M1_ZERO) = node.SCM(i1,i2+node.SCM.nB2,i3,DV_ZERO_M1_ZERO);
	       			 node.SCM(i1,i2,i3,DV_ZERO_ZERO_M1) = node.SCM(i1,i2,i3+node.SCM.nB2,DV_ZERO_ZERO_M1);
				 ...
				 cell.SCM(i1,i2,i3,DV_M1_ZERO_ZERO) = cell.SCM(i1+cell.SCM.nB1,i2,i3,DV_M1_ZERO_ZERO);
	      			 cell.SCM(i1,i2,i3,DV_ZERO_M1_ZERO) = cell.SCM(i1,i2+cell.SCM.nB2,i3,DV_ZERO_M1_ZERO);
	       			 cell.SCM(i1,i2,i3,DV_ZERO_ZERO_M1) = cell.SCM(i1,i2,i3+cell.SCM.nB2,DV_ZERO_ZERO_M1);
			}
		}
	}
	...
	//FCC SHIFT
	//12
	for (int i3 = node.FCC12.iB3; i3 <= node.FCC12.iE1; i3++) {
	...
	for (int i2 = node.FCC13.iB2; i2 <= node.FCC13.iE2; i2++) {
		...
		for (int i3 = node.FCC13.iE3; i3 >= node.FCC13.iB3; i3--) {
			for (int i1 = node.FCC13.iE1; i1 >= node.FCC13.iB1; i1--) {
				...
				node.FCC13(i1,i2,i3,DV_M1_ZERO_P1) = node.FCC13(i1+node.FCC13.nB1,i2,i3-node.FCC13.nB3,DV_M1_P1_ZERO);

				cell.FCC13(i1,i2,i3,DV_P1_ZERO_P1) = cell.FCC13(i1-cell.FCC13.nB1,i2,i3-cell.FCC13.nB3,DV_P1_ZERO_P1);
				cell.FCC13(i1,i2,i3,DV_M1_ZERO_P1) = cell.FCC13(i1+cell.FCC13.nB1,i2,i3-cell.FCC13.nB3,DV_M1_P1_ZERO);
			}
		}
	}
	//23
	...
	for (int i3 = node.BCCP.iE3; i3 >= node.BCCP.iB3; i3--) {
		for (int i2 = node.BCCP.iE2; i2 >= node.BCCP.iB2; i2--) {
			for (int i1 = node.BCCP.iE1; i1 >= node.BCCP.iB1; i1--) {				
				cell.BCCP(i1,i2,i3,DV_P1_P1_P1) = node.BCCP(i1-node.BCCP.nB1,i2-node.BCCP.nB2,i3-node.BCCP.nB3,DV_P1_P1_P1);
				cell.BCCP(i1,i2,i3,DV_M1_P1_P1) = node.BCCP(i1+node.BCCP.nB1,i2-node.BCCP.nB2,i3-node.BCCP.nB3,DV_M1_P1_P1);
				cell.BCCP(i1,i2,i3,DV_M1_M1_P1) = node.BCCP(i1+node.BCCP.nB1,i2+node.BCCP.nB2,i3-node.BCCP.nB3,DV_M1_M1_P1);
				cell.BCCP(i1,i2,i3,DV_P1_M1_P1) = node.BCCP(i1-node.BCCP.nB1,i2+node.BCCP.nB2,i3-node.BCCP.nB3,DV_P1_M1_P1);
			}
		}
		for (int i2 = node.BCCP.iE2; i2 >= node.BCCP.iB2; i2--) {
			for (int i1 = node.BCCP.iE1; i1 >= node.BCCP.iB1; i1--) {
				node.BCCP(i1,i2,i3,DV_P1_P1_P1) = cell.BCCP(i1-cell.BCCP.nB1,i2-cell.BCCP.nB2,i3-cell.BCCP.nB3,DV_P1_P1_P1);
				node.BCCP(i1,i2,i3,DV_M1_P1_P1) = cell.BCCP(i1+cell.BCCP.nB1,i2-cell.BCCP.nB2,i3-cell.BCCP.nB3,DV_M1_P1_P1);
				node.BCCP(i1,i2,i3,DV_M1_M1_P1) = cell.BCCP(i1+cell.BCCP.nB1,i2+cell.BCCP.nB2,i3-cell.BCCP.nB3,DV_M1_M1_P1);
				node.BCCP(i1,i2,i3,DV_P1_M1_P1) = cell.BCCP(i1-cell.BCCP.nB1,i2+cell.BCCP.nB2,i3-cell.BCCP.nB3,DV_P1_M1_P1);
			}
		}
	}
	//Negative
	for (int i3 = node.BCCP.iB3; i3 <= node.BCCP.iE3; i3++) {
		for (int i2 = node.BCCP.iB2; i2 <= node.BCCP.iE2; i2++) {
			for (int i1 = node.BCCP.iB1; i1 <= node.BCCP.iE1; i1++) {
				node.BCCP(i1,i2,i3,DV_M1_M1_M1) = cell.BCCP(i1+cell.BCCP.nB1,i2+cell.BCCP.nB2,i3+cell.BCCP.nB3,DV_M1_M1_M1);
				node.BCCP(i1,i2,i3,DV_M1_P1_M1) = cell.BCCP(i1+cell.BCCP.nB1,i2-cell.BCCP.nB2,i3+cell.BCCP.nB3,DV_M1_P1_M1);
				node.BCCP(i1,i2,i3,DV_P1_M1_M1) = cell.BCCP(i1-cell.BCCP.nB1,i2+cell.BCCP.nB2,i3+cell.BCCP.nB3,DV_P1_M1_M1);
				node.BCCP(i1,i2,i3,DV_P1_P1_M1) = cell.BCCP(i1-cell.BCCP.nB1,i2-cell.BCCP.nB2,i3+cell.BCCP.nB3,DV_P1_P1_M1);
			}
		}
		for (int i2 = node.BCCP.iB2; i2 <= node.BCCP.iE2; i2++) {
			for (int i1 = node.BCCP.iB1; i1 <= node.BCCP.iE1; i1++) {
				cell.BCCP(i1,i2,i3,DV_M1_M1_M1) = node.BCCP(i1+node.BCCP.nB1,i2+node.BCCP.nB2,i3+node.BCCP.nB3,DV_M1_M1_M1);
				cell.BCCP(i1,i2,i3,DV_M1_P1_M1) = node.BCCP(i1+node.BCCP.nB1,i2-node.BCCP.nB2,i3+node.BCCP.nB3,DV_M1_P1_M1);
				cell.BCCP(i1,i2,i3,DV_P1_M1_M1) = node.BCCP(i1-node.BCCP.nB1,i2+node.BCCP.nB2,i3+node.BCCP.nB3,DV_P1_M1_M1);
				cell.BCCP(i1,i2,i3,DV_P1_P1_M1) = node.BCCP(i1-node.BCCP.nB1,i2-node.BCCP.nB2,i3+node.BCCP.nB3,DV_P1_P1_M1);
			}
		}
	}
